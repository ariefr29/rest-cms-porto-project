        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-slate-500 mt-2">Welcome back to your CMS. Here's an overview of your portfolio.</p>
                </div>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <Card className="border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-slate-500 mt-1">Active project folders</p>
                    </CardContent>
                </Card>
                ...
                <Card className="border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold text-slate-900">{stats.sitesCount}</div>
                        <p className="text-xs text-slate-500 mt-1"> deployed endpoints</p>
                    </CardContent>
                </Card>
            </div>
            ...
            <div className="space-y-4">
                ...
                <div className="grid gap-6 md:grid-cols-3">
                    {/* Step 1 */}
                    <Card className="bg-white border-slate-200 relative overflow-hidden group hover:border-blue-200 transition-colors">
